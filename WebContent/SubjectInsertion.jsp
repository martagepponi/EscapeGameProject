...
<script>
	...
	function createSubjects() {
		...
		makeCall("GET", "RoomCreation?action=addSubject&subjectName=" + name
				+ "&subjectYear=" + year, confirmInsertion);
...
<body>
	<div class="introDue">
		...
		<div class="dbSubject">
			...
			%>
			<p>
				<b> Le materie già presenti sono: </b>
			</p>
			<table>
				<tr>
					<td>Nome</td>
			...
			<div class="AddSubject">
				...
				<button class="btnHome mb-3 " data-bs-toggle="modal"
					...
					onclick="initializeListener()">Aggiungi una nuova materia</button>
			...
			<div class="modal fade" id="exampleModal" tabindex="-1"
				...
				<div
					...
					<form name="FormSubjectAdd" onsubmit="return false;"
						class="quote-container">
						<img src="images/logo.png"> <input type="text"
							class="form-control text1" placeholder="Nome Materia"
							name="subjectName" id="subjectName" required> <input
							type="text" class="form-control text1"
							placeholder="Anno della Materia" name="subjectYear"
							id="subjectYear" required>
						<div class="error" id="empty_field" style="display: none;">Completa
							tutti i campi</div>
						<div class="error" id="year_NaN" style="display: none;">Il
							campo anno deve essere un numero (1, 2, 3)</div>
						<input type="submit" class="btnA" value="Aggiungi"
							id="createSubject">
