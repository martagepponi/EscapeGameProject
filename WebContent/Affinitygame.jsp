...
<body class="affinityGame" onload="load()">
	<div id="title">
		...
		<h3>Trova una parola che leghi le quattro parole scritte qui
			sotto:</h3>
	</div>
	<div id="divMain" class="line-1 anim-typewriter">
		<p id="affinityWord"><%=word1 %>,
			<%=word2%>,
			<%=word3%>,
			<%=word4%></p>
	</div>
	<p id="question2" align="center"
		style="display: <%= (minigame.isHintSelected() ? "block" : "none") %>;"><%=(minigame.isHintSelected() ? minigame.getHint() : "") %></p>

	<div id="div2" class="correctWord">
		<input id="wordToCheck" class=" text2" type="text"
			placeholder="inserisci la parola più adatta" value=""> <input
			type="button" class="btnA send" value="Invia" onclick="Word()">
	...
	<div id="prize" align="center" style="display: none;">
		...
		<p id="showWord" style="display: none;">
			La parola corretta era: <span id="correctWord"></span>
		</p>
		...
		<br> <a href="./Game"> <input type="button"
			class="btnA backR " value="Torna alla stanza"></a>
